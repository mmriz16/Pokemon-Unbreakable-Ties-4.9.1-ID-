...
- [x] Audit runtime sumber teks (`Data/Scripts`, `PBS`, `Data/*.dat`, event maps)
- [x] Siapkan repo kerja lokal di folder `Pokemon Unbreakable Ties 4.9.1 (ID)`
- [x] Push branch audit ke GitHub
- [x] Definisikan aturan rebuild `english.dat`
- [x] Bangun script rebuild `english.dat` versi Indonesia
- [x] Generate `Data/english.dat` di folder `ID`
